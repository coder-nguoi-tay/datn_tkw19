    ...
    <div class="dashboard-nav-container">
        ...
        <div class="side-menu-wrap">
            <ul class="side-menu-ul">
                <li><a href="{{ route('employer.index') }}"><i class="fas fa-chart-line icon-element"></i>
                        Thống kê</a></li>
                ...
                <li><a href="/employer/business-license"><i class="fas fa-file icon-element"></i> Giấy
                        phép kinh
                        Doanh</a>
                </li>
                ...
                <li><a href="/employer/profile-employer"><i class="fas fa-building icon-element"></i>
                        Công ty</a>
                </li>
                <li><a href="/employer/change-password"><i class="fas fa-lock icon-element"></i> Đổi
                        mật khẩu</a>
                </li>
