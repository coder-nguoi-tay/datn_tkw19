        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div>
                            <create-new-employer></create-new-employer>
                        </div>
                        ...
                        <!-- <div class="accordion">
                            <div class="card recuitment-card">
                                ...
                                <form action="{{ route('employer.new.store') }}" method="POST">
                                    @csrf
                                    <div id="collapseOne" class="collapse  show">
                                        <div class="card-body recuitment-body">
                                            <div class="form-group row">
                                                <label class="col-sm-3 col-form-label text-right label">Tiêu đề<span class="pl-2">*</span></label>
                                                <div class="col-sm-9">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-sm-3 col-form-label text-right label">Số lượng cần
                                                    tuyển</label>
                                                <div class="col-sm-9">
                                                    <input name="quatity" type="number" class="form-control" placeholder="Số lượng cần tuyển" />
                                                    <span class="error" name="quatity">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-sm-3 col-form-label text-right label">Giới tính<span class="pl-2">*</span></label>
                                                <div class="col-sm-9">
                                                    <select name="sex" id="" as='select' class="form-control">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input name="describe" type="text" class="form-control" placeholder="Mô tả công việc" />
                                            ...
                                            <div class="form-group row">
                                                <label class="col-sm-3 col-form-label text-right label">Yêu cầu công
                                                    việc<span class="pl-2">*</span></label>
                                                <div class="col-sm-9">
                                                    <input name="candidate_requirements" type="text" class="form-control" placeholder="Yêu cầu công việc" />
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <select name="majors_id" id="" as='select' class="form-control">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-sm-3 col-form-label text-right label">Trình độ<span class="pl-2">*</span></label>
                                                <div class="col-sm-9">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-sm-3 col-form-label text-right label">Kinh nghiệm<span class="pl-2">*</span></label>
                                                <div class="col-sm-9">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-sm-3 col-form-label text-right label">Mức lương<span class="pl-2">*</span></label>
                                                <div class="col-sm-9">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <select name="time_work_id" as="select" class="form-control">
                                                        <option value disabled selected>Chọn Yêu cầu thời gian làm việc
                                                        </option>
                                            ...
                                            <div class="form-group row">
                                                <label class="col-sm-3 col-form-label text-right label">Quyền lợi<span class="pl-2">*</span></label>
                                                <div class="col-sm-9">
                                                    <input name="benefit" type="text" class="form-control" placeholder="Quyền lợi" />
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <select name="skill_id[]" class="form-select select2" aria-label="Default select example">
                                                ...
                                                <div class="card-body recuitment-body">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            ...
                                                            <input type="text" name="nameEmployer" value="{{ $user[0]->name }}" class="form-control" />
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-sm-3 col-form-label text-right label">Điện
                                                            thoại</label>
                                                        <div class="col-sm-9">
                                                            <input type="number" name="phoneEmployer" class="form-control" value="{{ $user[0]->phone }}" />
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-sm-3 col-form-label text-right label">Địa
                                                            chỉ</label>
                                                        <div class="col-sm-9">
                                                            <input type="text" name="addressEmployer" class="form-control" value="{{ $user[0]->address }}" />
                                            ...
                                            <div id="collapse4" class="collapse show" aria-labelledby="heading4" data-parent="#collapse4">
                                                <div class="card-body recuitment-body">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="text" name="nameCompany" class="form-control" value="{{ $company[0]->name ?? '' }}" placeholder="Tên công ty" />
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="text" name="addressCompany" class="form-control" value="{{ $company[0]->address ?? '' }}" placeholder="địa
                                                                    chỉ" />
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-sm-3 col-form-label text-right label">Email<span class="pl-2">*</span></label>
                                                        <div class="col-sm-9">
                                                            <input type="text" name="emailCompany" class="form-control" value="{{ $company[0]->email ?? '' }}" placeholder="Email" />
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="text" name="number_member" class="form-control" value="{{ $company[0]->number_member ?? '' }}" placeholder="số lượng nhân viên" />
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="text" name="logo" value="{{ $company[0]->logo ?? '' }}" class="form-control" placeholder="logo" />
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <textarea name="desceibeCompany" value="{{ $company[0]->Desceibe ?? '' }}" id="" cols="10" rows="5" class="form-control"></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
