                                                    ...
                                                    @foreach ($jobAttractive as $item)
                                                        <div class="col">
                                                            <div class="card-grid-2 grid-bd-16 hover-up">
                                                                <div class="card-block-info pt-25">
                                                                    <h6><a
                                                                            href="../job/lead-quality-control-qa-2/index.html">Lead
                                                                            Quality Control QA</a></h6>
                                                                    ...
                                                                    <div class="mt-20 border-bottom pb-20">
                                                                        <div class="d-flex flex-wrap gap-1">
                                                                            <span class="btn btn-grey-small"
                                                                                href="../candidate/skill/app/index.html">
                                                                                App </span>
                                                                            <span class="btn btn-grey-small"
                                                                                href="../candidate/skill/figma/index.html">
                                                                                Figma </span>
                                                                            <span class="btn btn-grey-small"
                                                                                href="../candidate/skill/java/index.html">
                                                                                Java </span>
                                                                        </div>
                                                                    </div>
                                                                    <div class="card-2-bottom mt-20">
