                                ...
                                <div class="search-inner">
                                    ...
                                    <div class="filter_wraps">
                                                            ...
                                                            <div class="inner_widget_link">
                                                                <ul class="no-ul-list filter-list">
                                                                    <li>
                                                                        ...
                                                                        <label for="a1"
                                                                            class="checkbox-custom-label">IT Computers
                                                                            (62)</label>
                                                                        <ul class="no-ul-list filter-list">
                                                                            <li>
                                                                                <input id="aa1"
                                                                                    class="checkbox-custom" name="ADA"
                                                                                    type="checkbox">
                                                                                <label for="aa1"
                                                                            ...
                                                                            <li>
                                                                                <input id="aa2"
                                                                                    class="checkbox-custom" name="Parking"
                                                                                    type="checkbox">
                                                                                <label for="aa2"
                                                                                    class="checkbox-custom-label">Web
                                                                            ...
                                                                            <li>
                                                                                <input id="aa3"
                                                                                    class="checkbox-custom" name="Coffee"
                                                                                    type="checkbox">
                                                                                <label for="aa3"
                                                                    ...
                                                                    <li>
                                                                        ...
                                                                        <label for="a2"
                                                                            class="checkbox-custom-label">Financial Service
                                                                            (16)</label>
                                                                    </li>
                                                                    <li>
                                                                    ...
                                                                    <li>
                                                                        ...
                                                                        <label for="a4"
                                                                            class="checkbox-custom-label">Coach & Education
                                                                            (21)</label>
                                                                    </li>
                                                                    <li>
                                                                ...
                                                                <ul class="no-ul-list filter-list">
                                                                    ...
                                                                    <li>
                                                                        <input id="b3" class="checkbox-custom"
                                                                            name="Coffee" type="checkbox">
                                                                        <label for="b3"
                                                                            class="checkbox-custom-label">United Kingdom
                                                                            (21)</label>
                                                                        <ul class="no-ul-list filter-list">
                                                                            <li>
                                                                                <input id="ac1"
                                                                        ...
                                                                        <ul class="no-ul-list filter-list">
                                                                            <li>
                                                                                <input id="ad1"
                                                                                    ...
                                                                                    type="checkbox">
                                                                                <label for="ad1"
                                                                                    class="checkbox-custom-label">New York
                                                                                    (32)</label>
                                                                            </li>
                                                                            <li>
                                                                                <input id="ad2"
                                                                ...
                                                                <ul class="no-ul-list filter-list">
                                                                    ...
                                                                    <li>
                                                                        <input id="c2" class="checkbox-custom"
                                                                            name="Parking" type="checkbox">
                                                                        <label for="c2"
                                                                            class="checkbox-custom-label">iPhone & Android
                                                                            (33)</label>
                                                                    </li>
                                                                    <li>
                                                                    ...
                                                                    <li>
                                                                        <input id="c4" class="checkbox-custom"
                                                                            name="Mother" type="checkbox">
                                                                        <label for="c4"
                                                                            class="checkbox-custom-label">Account Manager
                                                                            (21)</label>
                                                                    </li>
                                                                    <li>
                                            ...
                                            <div class="widget-boxed-header">
                                                <h4>
                                                    <a href="#experience" data-toggle="collapse" aria-expanded="false"
                                                        role="button"
                                                        class="ft-medium fs-md pb-0 collapsed">Experience</a>
                                                </h4>
                                                                ...
                                                                <ul class="no-ul-list filter-list">
                                                                    ...
                                                                    <li>
                                                                        <input id="d2" class="checkbox-custom"
                                                                            name="Parking" type="checkbox">
                                                                        <label for="d2"
                                                                            class="checkbox-custom-label">1+ Year
                                                                            (32)</label>
                                                                    </li>
                                                                    <li>
                                                                        <input id="d3" class="checkbox-custom"
                                                                            name="Coffee" type="checkbox">
                                                                        <label for="d3"
                                                                            class="checkbox-custom-label">2 Year
                                                                            (09)</label>
                                                                    </li>
                                                                    <li>
                                                                        <input id="d4" class="checkbox-custom"
                                                                            name="Mother" type="checkbox">
                                                                        <label for="d4"
                                                                            class="checkbox-custom-label">3+ Year
                                                                            (16)</label>
                                                                    </li>
                                                                    <li>
                                                                        <input id="d5" class="checkbox-custom"
                                                                            name="Outdoor" type="checkbox">
                                                                        <label for="d5"
                                                                            class="checkbox-custom-label">4+ Year
                                                                            (17)</label>
                                                                    </li>
                                                                    <li>
                                                                        <input id="d6" class="checkbox-custom"
                                                                            name="Pet" type="checkbox">
                                                                        <label for="d6"
                                                                            class="checkbox-custom-label">5+ Year
                                                                            (22)</label>
                                                                    </li>
                                                                    <li>
                                            ...
                                            <div class="widget-boxed-header">
                                                <h4>
                                                    <a href="#jbtypes" data-toggle="collapse" aria-expanded="false"
                                                        role="button" class="ft-medium fs-md pb-0 collapsed">Job Type</a>
                                                </h4>
                                                            ...
                                                            <div class="inner_widget_link">
                                                                <ul class="no-ul-list filter-list">
                                                                    <li>
                                                                        ...
                                                                        <label for="e2"
                                                                            class="radio-custom-label">Full time</label>
                                                                    </li>
                                                                    <li>
                                                                        <input id="e3" class="radio-custom"
                                                                            name="jtype" type="radio">
                                                                        <label for="e3"
                                                                            class="radio-custom-label">Part Time</label>
                                                                    </li>
                                                                    <li>
                                        ...
                                        <div class="single_search_boxed px-4 pt-0 br-bottom">
                                            ...
                                            <div class="widget-boxed-body collapse" id="jblevel"
                                                data-parent="#jblevel">
                                                <div class="side-list no-border">
                                                    <!-- Single Filter Card -->
                                                    <div class="single_filter_card">
                                    ...
                                    <div class="form-group filter_button pt-2 pb-4 px-4">
                                        <button type="submit"
                                            class="btn btn-md theme-bg text-light rounded full-width">22 Results
                                            Show</button>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-8 col-md-12 col-sm-12">
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-12">
                                <div
                                    class="row align-items-center justify-content-between mx-0 bg-white rounded py-2 mb-4">
                                        ...
                                        <div class="jb-list01">
                                            <div class="jb-list-01-title">
                                                <h5 class="ft-medium mb-1"><a
                                                        href="job-detail.html">{{ $item->title }}</a></h5>
                                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <span class="page-item">{{ $job->links() }}</span>
                            </div>
                        </div>
