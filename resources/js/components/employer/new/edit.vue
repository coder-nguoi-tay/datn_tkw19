                        ...
                        <div class="card-body recuitment-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <Multiselect v-model="this.data.skill" name="skill_id" mode="tags"
                                        :close-on-select="false" :searchable="true" :create-option="true" :options="[
                                         {value:this.data.job.getskill[0].id ,label:this.data.job.getskill[0].name  },
                                         {value:this.data.job.getskill[1].id ,label:this.data.job.getskill[1].name  },
                                         {value:this.data.job.getskill[2].id ,label:this.data.job.getskill[2].name  }
                                        ]" />
                                </div>
                            </div>
                            <!--  -->
                            ...
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label text-right label">Hạn nộp hồ sơ<span
                                        class="pl-2">*</span></label>
                                <div class="col-sm-9">
                                    <picker-new-employer v-model="model.end_job_time" name="end_job_time"
                    ...
                    <div class="card-body recuitment-body">
                        <div class="form-group row">
                            <label class="col-sm-3 col-form-label text-right label">Tên công ty<span
                                    class="pl-2">*</span></label>
                            <div class="col-sm-9">
                                <Field type="text" name="name" :value="this.data.company[0].name" v-model="model.name"
                        ...
                        <div class="form-group row">
                            <label class="col-sm-3 col-form-label text-right label">Địa chỉ<span
                                    class="pl-2">*</span></label>
                            <div class="col-sm-9">
                                <Field type="text" name="addressCompany" :value="this.data.company[0].address"
                                    v-model="model.address" class="form-control" placeholder="địa chỉ" />
                        ...
                        <div class="form-group row">
                            <label class="col-sm-3 col-form-label text-right label">Email<span
                                    class="pl-2">*</span></label>
                            <div class="col-sm-9">
                                <Field type="text" name="email" :value="this.data.company[0].email"
                                    v-model="model.email" class="form-control" placeholder="Email" />
                                <ErrorMessage class="error" name="email" />
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-3 col-form-label text-right label">Sơ lược về công ty<span
                                    class="pl-2">*</span></label>
                            <div class="col-sm-9">
                                <textarea class="form-control" name="Desceibe" :value="this.data.company[0].Desceibe"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <Field type="text" name="logo" v-model="model.logo" :value="this.data.company[0].logo"
                        ...
                        <div class="form-group row">
                            <label class="col-sm-3 col-form-label text-right label">Quy mô nhân sự<span
                                    class="pl-2">*</span></label>
                            <div class="col-sm-9">
                                <Field type="text" name="number_member" :value="this.data.company[0].number_member"
                                    v-model="model.number_member" class="form-control"
