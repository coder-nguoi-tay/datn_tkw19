                  ...
                  <CRow class="mb-2">
                    ...
                    <div class="col-sm-6">
                      <Field
                        ...
                        rules="min:8|max:16|password_rule"
                        class="form-control"
                      />
  ...
  data: function () {
    return {
      ...
      model: {
        ...
        prefecture_id: this.data.user.prefecture_id,
        city_id: this.data.user.city_id,
        address_building: this.data.user.address_building,
        job_type: this.data.user.job_type,
        name: this.data.user.name,
        name_kana: this.data.user.name_kana,
        representative_name: this.data.user.representative_name,
        job_descriptions: this.data.user.job_descriptions,
